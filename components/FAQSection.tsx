...
export default function FAQSection() {
  const [faqItems, setFaqItems] = useState<FAQItem[]>([
    ...
    {
      id: 3,
      question: '3. Are loans available in all states?',
    ...
    {
      id: 4,
      question: '4. Do you check credit scores?',
    ...
    {
      id: 5,
      question: '5. Can I apply with bad credit?',
